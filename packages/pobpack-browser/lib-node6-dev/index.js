...
const RunOptions = _flowRuntime2.default.type('RunOptions', _flowRuntime2.default.object(_flowRuntime2.default.property('host', _flowRuntime2.default.string(), true), _flowRuntime2.default.property('port', _flowRuntime2.default.number()), _flowRuntime2.default.property('https', _flowRuntime2.default.nullable(_flowRuntime2.default.boolean()), true)));
